...
-   «**username»** -- имя технологического пользователя подсистемы доступа, учётную запись которого использует интеграционный модуль;
-   «**password»** -- пароль технологического пользователя подсистемы доступа, учётную запись которого использует интеграционный модуль;
-   **«ip»** -- IP-адрес рабочей станции, на которой расположена серверная часть подсистемы доступа.
